...
function trocaImagemCupomMenuMobile() {
  ...
  const existsElement = document.querySelector("#bottom-navigation > div:nth-child(5) > span > svg")
  ...
  document.querySelector("#bottom-navigation > div:nth-child(5) > span").appendChild(newImage);
}
